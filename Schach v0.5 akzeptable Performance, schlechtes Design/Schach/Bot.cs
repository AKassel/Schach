    ...
    internal class Bot
    {
        ...
        public void Ziehen()
        {
            if (false)
            {
                ...
                stopwatch3.Stop();
                Debug.WriteLine(stopwatch4.ElapsedMilliseconds + "ms R4: " + Test4);
        ...
        public int MoeglicheZuegeTest(int Tiefe, Schachfeld schachfeldOrg)
        {
            ...
            if (Tiefe > 2)
            {
                Parallel.ForEach(zuege, zug =>
                {
                    ...
                    {
                        if(bauer == Kopie.enpassantBauer)
                        {
                            if(schachfeldOrg.enpassantBauer == schachfeldOrg.figurBei(zug.figur.row, zug.figur.col))
                            {
        ...
        public List<Zug> FolgeZuegeHinzufuegen(int Tiefe, List<Zug> zuege, Schachfeld schachfeld1)
        {
            ...
            if (Tiefe == 1)
            {
                foreach (Zug zug in zuege)
                {
                    ...
                    zug.bewertung = zug.FigurenZaehlen(schachfeld1);
            ...
            if (true)
            {
                Parallel.ForEach(zuege, zug =>
                {
                    ...
                    Schachfeld Kopie = new Schachfeld(schachfeld1);
                    zug.figur = Kopie.figurBei(zug.figur.row, zug.figur.col);
                ...
                foreach (Zug zug in MoeglicheZuege)
                {
                    if (zug.row == 0 || zug.row == 7)
                    {
                        if (figur.weiss)
                        {
                            ...
                            Rzuege.Add(zug);
                            MoeglicheZuege.Add(zurDame);
                            MoeglicheZuege.Add(zumLaeufer);
                            MoeglicheZuege.Add(zumSpringer);
                            MoeglicheZuege.Add(zumTurm);
        ...
        public List<Zug> MoeglicheZuegeFuerWeissOderSchwarzSuchen(Schachfeld schachfeld1)
        {
            ...
            foreach (Figur figur in schachfeld1.ListDerFiugrenAmZug())
            {
